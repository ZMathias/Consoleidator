...
constexpr Keycombo registeredCombos[] = {
	{ALT_MOD | CONTROL_MOD | SHIFT_MOD, VK_F5, HOTKEY_TOGGLE_SHOW},
	{SHIFT_MOD | CONTROL_MOD, VK_DELETE, HOTKEY_CLEAR_CONSOLE},
	{CONTROL_MOD | ALT_MOD, 0x4D, HOTKEY_MAXIMIZE_BUFFER},
	{CONTROL_MOD | ALT_MOD, VK_END, HOTKEY_RESET},
	{CONTROL_MOD | ALT_MOD, VK_RIGHT, HOTKEY_FOREGROUND_FORWARD},
	{CONTROL_MOD | ALT_MOD, VK_LEFT, HOTKEY_FOREGROUND_BACKWARD},
	{CONTROL_MOD | ALT_MOD, VK_UP, HOTKEY_BACKGROUND_FORWARD},
	{CONTROL_MOD | ALT_MOD, VK_DOWN, HOTKEY_BACKGROUND_BACKWARD},
};
